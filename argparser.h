...
void print_help()
{
    ...
    printf("\t-qtry createeventgroup [GROUP_DESC] [EXPECTED_MARKET_COUNT] [MODE]\n");
    printf("\t\tCreate a draft event group. MODE is independent/0 or exclusive_one/1. Game operator only.\n");
    printf("\t-qtry addmarket [EVENT_GROUP_ID] [MARKET_DESC] [OPTION_0_DESC] [OPTION_1_DESC] [END_DATE] [TAG_ID]\n");
    printf("\t\tAdd a binary market to a draft group. Charges feePerDay for the market duration. Game operator only.\n");
    printf("\t-qtry openevent [EVENT_GROUP_ID]\n");
    printf("\t\tOpen a complete draft group and enable trading in its markets. Game operator only.\n");
    printf("\t-qtry canceleventgroup [EVENT_GROUP_ID]\n");
    printf("\t\tCancel a draft event group and remove its child markets. Game operator only.\n");
    ...
    printf("\t-qtry geteventgroup [EVENT_GROUP_ID]\n");
    printf("\t\tGet event group metadata, child market IDs, result and dispute state.\n");
    printf("\t-qtry getmarketeventgroup [MARKET_ID]\n");
    printf("\t\tGet the event group and market index linked to a child market.\n");
    printf("\t-qtry geteventgroupinfobatch [EVENT_GROUP_ID_1] ... [EVENT_GROUP_ID_N]\n");
    printf("\t\tGet metadata for up to 64 event groups in one request.\n");
    printf("\t-qtry publisheventresult [EVENT_GROUP_ID] [WINNING_MARKET_ID]\n");
    printf("\t\tPublish the winner of an EXCLUSIVE_ONE group. Game operator only; locks the dispute deposit.\n");
    printf("\t-qtry disputeeventresult [EVENT_GROUP_ID]\n");
    printf("\t\tDispute an EXCLUSIVE_ONE group result. Requires the dispute deposit amount.\n");
    printf("\t-qtry resolveeventdispute [EVENT_GROUP_ID] [WINNING_MARKET_ID]\n");
    printf("\t\tVote to resolve an event group dispute. Computor only; invocation reward is refunded to a computor.\n");
